...
--
-- Servidor: localhost
-- Tiempo de generación: 19-04-2014 a las 22:42:29
...
(1, 'Default Site', 'default', 'localhost', 1, 1391276313, 0);
...
(1, 'guillefd@gmail.com', '6f91e55502dc2a465c62d192480d2cfbe3e34c3f', 'd80f2', 1, '', 1, '', 1391276312, 1391276312, 'admin', NULL, NULL);
...
('332488aead3dddb47037ea94ec56da3d', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.102 Safari/537.36', 1391517716, 'a:6:{s:8:"username";s:5:"admin";s:5:"email";s:18:"guillefd@gmail.com";s:2:"id";s:1:"1";s:7:"user_id";s:1:"1";s:8:"group_id";s:1:"1";s:5:"group";s:5:"admin";}'),
('a1ae409b7a603f4c516bd7f833db4488', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.107 Safari/537.36', 1391517780, ''),
('2fab723936e2c71e8b1c53480a926331', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.107 Safari/537.36', 1391551734, 'a:7:{s:8:"username";s:5:"admin";s:5:"email";s:18:"guillefd@gmail.com";s:2:"id";s:1:"1";s:7:"user_id";s:1:"1";s:8:"group_id";s:1:"1";s:5:"group";s:5:"admin";s:13:"captcharesult";i:6;}');
...
(17, 'partial', 'partial', 'pages', 'textarea', 0x613a333a7b733a31323a2264656661756c745f74657874223b733a303a22223b733a31303a22616c6c6f775f74616773223b733a313a2279223b733a31323a22636f6e74656e745f74797065223b733a343a2268746d6c223b7d, NULL, 'no');
...
(17, 1, 2, 17, 'no', 'no', 'Nombre de la vista parcial', NULL);
...
CREATE TABLE IF NOT EXISTS `default_def_page_fields` (
  ...
  `partial` longtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`)
...
INSERT INTO `default_def_page_fields` (`id`, `created`, `updated`, `created_by`, `ordering_count`, `body`, `partial`) VALUES
(1, '2014-02-01 17:38:49', '2014-02-02 01:46:40', 1, NULL, NULL, '{{ theme:partial name="pages/inicio" }}'),
(2, '2014-02-01 17:38:49', '2014-02-04 13:19:33', 1, NULL, NULL, '{{ theme:partial name="pages/form-contacto" }}'),
(3, '2014-02-01 17:38:49', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}', NULL),
(4, '2014-02-01 17:38:49', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}\n\n{{ search:results }}\n\n	{{ total }} results for "{{ query }}".\n\n	<hr />\n\n	{{ entries }}\n\n		<article>\n			<h4>{{ singular }}: <a href="{{ url }}">{{ title }}</a></h4>\n			<p>{{ description }}</p>\n		</article>\n\n	{{ /entries }}\n\n        {{ pagination }}\n\n{{ /search:results }}', NULL),
(5, '2014-02-01 17:38:49', NULL, 1, NULL, '<p>We cannot find the page you are looking for, please click <a title="Home" href="{{ pages:url id=''1'' }}">here</a> to go to the homepage.</p>', NULL),
(6, '2014-02-02 00:53:25', '2014-02-02 01:26:27', 1, 1, NULL, '{{ theme:partial name="pages/cloud-hosting" }}'),
(7, '2014-02-02 01:09:34', NULL, 1, 2, NULL, '{{ theme:partial name="pages/desarrollo-web" }}'),
(8, '2014-02-02 01:24:59', '2014-02-02 01:30:18', 1, 3, NULL, '{{ theme:partial name="pages/servicios-nube" }}');
...
(1, 'home', '', 'Home', 'home', 0, '1', '1', '', '', '', '', 0, 0, '', 0, 0, 'live', 1391276330, 1391305600, '0', 1, 1, 0),
(2, 'contactanos', '', 'Contactanos', 'contactanos', 0, '1', '2', '', '', '', '', 0, 0, '', 0, 0, 'live', 1391276330, 1391519973, '0', 0, 1, 5),
(3, 'search', '', 'Search', 'search', 0, '1', '3', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1391276330, 0, '', 0, 1, 4),
(4, 'results', '', 'Results', 'search/results', 3, '1', '4', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1391276330, 0, '', 0, 0, 0),
(5, '404', '', 'Page missing', '404', 0, '1', '5', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1391276330, 0, '', 0, 1, 6),
(6, 'cloud-hosting-de-aplicaciones', '', 'Cloud hosting de aplicaciones', 'cloud-hosting-de-aplicaciones', 0, '1', '6', '', '', '', '', 0, 0, '', 0, 0, 'live', 1391302405, 1391304387, '0', 0, 1, 1),
(7, 'desarrollo-de-aplicaciones-web', '', 'Desarrollo de aplicaciones web', 'desarrollo-de-aplicaciones-web', 0, '1', '7', '', '', '', '', 0, 0, '', 0, 0, 'live', 1391303374, 0, '0', 0, 1, 3),
(8, 'servicios-en-la-nube', '', 'Servicios en la nube', 'servicios-en-la-nube', 0, '1', '8', '', '', '', '', 0, 0, '', 0, 0, 'live', 1391304299, 1391304618, '0', 0, 1, 2);
...
(1, 'default', 'Default', 'A simple page type with a WYSIWYG editor that will get you started adding content.', 2, '', NULL, '', '{{ body }}\r\n{{ partial }}', '', '', 'default.html', 1391306034, 'n', '', '');
...
(1, NULL, NULL, NULL, NULL, 1, 'Admin Rewrite', 'Admin', 'Rewrite', '', 'en', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Estructura de tabla para la tabla `default_rwform`
--

CREATE TABLE IF NOT EXISTS `default_rwform` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` int(11) DEFAULT NULL,
  `email` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `sender_data` text COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Volcado de datos para la tabla `default_rwform`
--

INSERT INTO `default_rwform` (`id`, `userid`, `email`, `sender_data`, `message_data`, `ip_address`, `user_agent`, `date`) VALUES
(1, 1, 'guillefd@gmail.com', 'a:6:{s:5:"email";s:18:"guillefd@gmail.com";s:4:"name";s:5:"Admin";s:5:"phone";s:2:"--";s:5:"movil";s:2:"--";s:4:"city";s:2:"--";s:7:"company";s:2:"--";}', 'a:11:{s:10:"currenturl";s:2:"--";s:7:"subject";s:11:"Presupuesto";s:12:"msg_location";s:2:"--";s:9:"msg_hours";s:2:"--";s:11:"msg_totdays";s:2:"--";s:13:"msg_startdate";s:2:"--";s:11:"msg_enddate";s:2:"--";s:14:"msg_schedule_1";s:2:"--";s:14:"msg_schedule_2";s:2:"--";s:7:"msg_pax";s:2:"--";s:12:"msg_comments";s:2:"--";}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.107 Safari/537.36', '1391525772'),
(2, 1, 'guillefd@gmail.com', 'a:6:{s:5:"email";s:18:"guillefd@gmail.com";s:4:"name";s:5:"Admin";s:5:"phone";s:2:"--";s:5:"movil";s:2:"--";s:4:"city";s:2:"--";s:7:"company";s:2:"--";}', 'a:11:{s:10:"currenturl";s:2:"--";s:7:"subject";s:11:"Presupuesto";s:12:"msg_location";s:2:"--";s:9:"msg_hours";s:2:"--";s:11:"msg_totdays";s:2:"--";s:13:"msg_startdate";s:2:"--";s:11:"msg_enddate";s:2:"--";s:14:"msg_schedule_1";s:2:"--";s:14:"msg_schedule_2";s:2:"--";s:7:"msg_pax";s:2:"--";s:12:"msg_comments";s:4:"daga";}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.107 Safari/537.36', '1391526908');
...
(16, 'Home', '', NULL, NULL, 'pages', 'pages:page', 'pages:pages', '1', 'home', 'admin/pages/edit/1', 'admin/pages/delete/1'),
...
(18, 'Contactanos', '', NULL, NULL, 'pages', 'pages:page', 'pages:pages', '2', 'contactanos', 'admin/pages/edit/2', 'admin/pages/delete/2'),
(13, 'Cloud hosting de aplicaciones', '', NULL, NULL, 'pages', 'pages:page', 'pages:pages', '6', 'cloud-hosting-de-aplicaciones', 'admin/pages/edit/6', 'admin/pages/delete/6'),
(10, 'Desarrollo de aplicaciones web', '', NULL, NULL, 'pages', 'pages:page', 'pages:pages', '7', 'desarrollo-de-aplicaciones-web', 'admin/pages/edit/7', 'admin/pages/delete/7'),
(14, 'Servicios en la nube', '', NULL, NULL, 'pages', 'pages:page', 'pages:pages', '8', 'servicios-en-la-nube', 'admin/pages/edit/8', 'admin/pages/delete/8');
...
('contact_email', 'Contact E-mail', 'All e-mails from users, guests and the site will go to this e-mail address.', 'text', 'guillefd@gmail.com', '', '', 1, 1, 'email', 979),
...
('default_theme', 'Default Theme', 'Select the theme you want users to see by default.', '', 'default', 'rw1', 'func:get_themes', 1, 0, '', 0),
...
('meta_topic', 'Meta Topic', 'Two or three words describing this type of company/website.', 'text', 'Content Management', 'Servicios, Soluciones y desarrollos Web', '', 0, 1, '', 998),
...
('site_name', 'Site Name', 'The name of the website for page titles and for use around the site.', 'text', 'Un-named Website', 'ReWrite Media', '', 1, 1, '', 1000),
...
('site_slogan', 'Site Slogan', 'The slogan of the website for page titles and for use around the site', 'text', '', 'Servicios, Soluciones y desarrollos Web', '', 0, 1, '', 999),
...
(1, 'guillefd@gmail.com', '6f91e55502dc2a465c62d192480d2cfbe3e34c3f', 'd80f2', 1, '', 1, '', 1391276312, 1391519531, 'admin', '187783deba0674183bd520207d3d04ebd95403c1', '2e7d4d58c2f72e8e113f80dca1cb6ae6c5c105e9');
